          ...
          <a href="/?brand={{ $brands[0]->slug }}">
            <div class="card bg-dark text-white">
              ...
              <div class="card-img-overlay d-flex align-items-center p-0">
                <h5 class="card-title text-center flex-fill p-4 fs-3" style="background-color: rgba(0, 0, 0, 0.7)">{{ $brands[0]->name }}</h5>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-md-4 mb-3">
          <a href="/?brand={{ $brand->slug }}">
            <div class="card bg-dark text-white">
              ...
              @endif
              <div class="card-img-overlay d-flex align-items-center p-0">
                <h5 class="card-title text-center flex-fill p-4 fs-3" style="background-color: rgba(0, 0, 0, 0.7)">{{ $brand->name }}</h5>
              </div>
            </div>
          </a>
        </div>
